...
##### Read the [paper.docx](https://github.com/Modem-i4/CryptoForecast/blob/master/Paper.docx) or check the [Github Repo](https://github.com/Modem-i4/CryptoForecast) to learn more about it!
""")
